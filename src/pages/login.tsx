...
import { setListMenuHeader } from '@/store/common-slice';
import { LIST_MENU_WITH_USER } from '@/component/header-feature/header-feature.constant';
...
const SignInPage = () => {
  ...
  const handleLogin = async (values: LoginType) => {
    ...
    if (res?.status === CODE_SUCCESS) {
      ...
      dispatch(setListMenuHeader(LIST_MENU_WITH_USER));
    } else {
